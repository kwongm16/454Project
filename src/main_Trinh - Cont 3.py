...
def WriteBusData(numBuses, theta, V): 
    ...
    worksheet1.write(1,4,largestPmis[0][0])
    worksheet1.write(1,5,largestPmis[0][1])
    worksheet1.write(1,6,largestQmis[0][0])
    worksheet1.write(1,7,largestQmis[0][1])    
...
def WriteLineData():
    ...
    worksheet2.write(0,8,'Limit Warning (MVA) ')
